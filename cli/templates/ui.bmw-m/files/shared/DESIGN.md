# Vector M — Bmw M-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-bmw-m.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Vector M brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Performance, distilled. A limited electric grand tourer engineered around balance, response, and a singular line.
