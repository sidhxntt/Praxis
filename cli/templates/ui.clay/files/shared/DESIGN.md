# Signalcraft — Clay-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-clay.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Signalcraft brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Turn good signals into great relationships. A creative growth workspace that helps teams research, enrich, and reach the right people.
