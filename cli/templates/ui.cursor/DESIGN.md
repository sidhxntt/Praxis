# Threadline — Cursor-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-cursor.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Threadline brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Build in the flow of thought. An intelligent code workspace that keeps context close and friction out of the way.
