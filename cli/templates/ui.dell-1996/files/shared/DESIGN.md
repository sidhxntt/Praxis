# PixelPort — Dell 1996-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-dell-1996.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional PixelPort brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

The future just dialed in. A joyful desktop gateway packed with bright ideas, useful tools, and unmistakable web nostalgia.
