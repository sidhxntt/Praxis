# Campfire — Discord-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-discord.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Campfire brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Your people, all in one place. A lively home for communities to talk, create, play, and keep their shared culture close.
