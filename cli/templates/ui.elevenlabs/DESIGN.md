# Resonant — Elevenlabs-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-elevenlabs.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Resonant brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Give every idea a voice. A studio for creating expressive, natural audio across stories, products, and languages.
