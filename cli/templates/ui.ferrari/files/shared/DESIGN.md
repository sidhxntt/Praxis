# Rosso Works — Ferrari-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-ferrari.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Rosso Works brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Born from the racing line. A modern performance atelier translating track discipline into an unforgettable road experience.
