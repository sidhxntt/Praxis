# Brightworks — HP-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-hp.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Brightworks brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Technology made more human. Reliable tools designed to help people learn, create, and do their best work anywhere.
