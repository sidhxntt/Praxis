# Veloce — Lamborghini-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-lamborghini.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Veloce brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Defy the ordinary line. An uncompromising electric performance concept cut from light, sound, and angular motion.
