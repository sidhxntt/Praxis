# Orbit Pay — Mastercard-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-mastercard.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Orbit Pay brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

A world of moments, moving freely. Human-centered payment experiences that connect everyday choices with global possibility.
