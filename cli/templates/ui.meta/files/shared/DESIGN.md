# Commonspace — Meta-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-meta.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Commonspace brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Feel closer, wherever you are. Open tools for sharing presence, making together, and turning distance into connection.
