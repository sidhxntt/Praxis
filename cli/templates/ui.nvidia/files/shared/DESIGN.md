# Parallel — Nvidia-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-nvidia.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Parallel brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Compute what comes next. Accelerated systems for researchers and builders working at the edge of simulation and intelligence.
