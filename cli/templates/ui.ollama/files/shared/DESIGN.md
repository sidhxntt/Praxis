# Localmind — Ollama-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-ollama.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Localmind brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Intelligence, close to home. A simple local runtime that keeps powerful models private, portable, and ready to explore.
