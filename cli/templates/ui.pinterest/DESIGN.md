# Museboard — Pinterest-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-pinterest.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Museboard brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Find the idea behind your next idea. A visual place to collect possibilities, follow curiosity, and shape inspiration into a plan.
