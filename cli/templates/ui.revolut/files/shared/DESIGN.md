# Flux Finance — Revolut-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-revolut.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Flux Finance brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Money without the old boundaries. One modern account for spending, saving, exchanging, and seeing the whole picture clearly.
