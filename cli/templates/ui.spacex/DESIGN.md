# Altitude — Spacex-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-spacex.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Altitude brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Make distance feel possible. A mission-driven aerospace program building reusable systems for the next era of exploration.
