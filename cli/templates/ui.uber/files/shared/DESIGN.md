# Cityline — Uber-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-uber.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Cityline brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Go where the day takes you. A direct, dependable way to move through the city, from the first mile to the last.
