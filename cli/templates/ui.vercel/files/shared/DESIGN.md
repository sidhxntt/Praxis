# Vertex Cloud — Vercel-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-vercel.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Vertex Cloud brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

The web, at your pace. A precise delivery platform that helps product teams turn code into fast, resilient experiences.
