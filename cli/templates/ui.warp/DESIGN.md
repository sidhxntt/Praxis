# Vector Terminal — Warp-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-warp.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Vector Terminal brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

The command line, moving with you. A modern terminal workspace that brings context, collaboration, and speed to every command.
