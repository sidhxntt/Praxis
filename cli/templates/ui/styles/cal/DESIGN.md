# Tempo — Cal-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-cal.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Tempo brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Time that feels like yours. A calmer way to shape meetings, protect focus, and keep a team in step.
