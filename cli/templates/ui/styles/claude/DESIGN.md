# Hearth — Claude-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-claude.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Hearth brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Thoughtful work starts with a better conversation. A warm, clear thinking space for exploring ideas and turning them into useful work.
