# Papertrail — Notion-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-notion.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Papertrail brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

A quieter place for everything you know. Documents, projects, and team memory arranged in one calm, adaptable workspace.
