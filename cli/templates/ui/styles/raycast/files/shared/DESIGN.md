# Swiftdeck — Raycast-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-raycast.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Swiftdeck brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Everything you need, one thought away. A polished command space that turns daily tools and tiny actions into effortless momentum.
