# Current Motors — Tesla-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-tesla.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Current Motors brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Electric, without compromise. A clean-sheet vehicle shaped around range, simplicity, and the pleasure of instant response.
