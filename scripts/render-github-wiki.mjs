...
const pages = [
  ...
  ["standard-frontend-architecture.md", "Standard-Frontend-Architecture.md"],
  ...
  ["compose-architecture.md", "Compose-Architecture.md"],
  ["kubernetes-architecture.md", "Kubernetes-Architecture.md"],
  ["terraform-architecture.md", "Terraform-Architecture.md"],
  ["extending-generated-projects.md", "Extending-Generated-Projects.md"],
  ["generated-backends.md", "Generated-Backends.md"],
  ["ui-templates.md", "UI-Templates.md"],
  ["testing.md", "Testing.md"],
  ["agent-guide.md", "Agent-Guide.md"],
  ["template-agent-guide.md", "Template-Agent-Guide.md"],
