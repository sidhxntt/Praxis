# Wayfarer — Airbnb-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-airbnb.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Wayfarer brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Stay somewhere that stays with you. A thoughtful travel collection shaped around local character and effortless arrival.
