# Meridian Ledger — Binance-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-binance.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Meridian Ledger brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Move value with confidence. A precise financial platform for seeing markets clearly and acting without friction.
