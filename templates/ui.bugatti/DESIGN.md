# Élan Atelier — Bugatti-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-bugatti.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Élan Atelier brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

An object in motion. A work at rest. A hand-finished performance study where material, proportion, and velocity meet.
