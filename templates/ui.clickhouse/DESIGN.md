# Columnar — Clickhouse-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-clickhouse.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Columnar brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Answers at the speed of curiosity. A high-performance analytics engine built for deep questions over enormous live datasets.
