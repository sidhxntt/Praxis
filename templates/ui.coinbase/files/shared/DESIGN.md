# Harbor — Coinbase-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-coinbase.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Harbor brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

A clearer way into digital finance. Secure tools and plain-language guidance for holding, moving, and understanding value.
