# Relay Mobile — Expo-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-expo.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Relay Mobile brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Ship the moment it works. One focused toolkit for building, testing, and delivering ambitious cross-platform experiences.
