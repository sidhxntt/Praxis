# Bloomlab — Lovable-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-lovable.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Bloomlab brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Turn an idea into something people can use. A friendly building space that helps small teams move from a sentence to a polished product.
