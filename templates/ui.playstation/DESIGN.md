# Nightplay — Playstation-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-playstation.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Nightplay brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

Enter a world worth staying in. A cinematic home for new stories, shared adventures, and unforgettable ways to play.
