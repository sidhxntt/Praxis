# Tracewell — Sentry-Inspired Landing Page Design

Source specification: `templates/designs/DESIGN-sentry.md`.

This is an original Praxis Flow implementation inspired by the visual principles documented below. It is not affiliated with or endorsed by the referenced company. The fictional Tracewell brand, all page copy, and the local composition artwork are original. No logos, proprietary product copy, or third-party imagery are included.

## Generated-page intent

See the problem before it becomes the story. Observability that connects errors, performance, and releases into one useful path to a fix.
