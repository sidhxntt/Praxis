    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <form
        onSubmit={handleSubmit((data) =>
          onLogin(data, setServerError, reset, router)
        )}
      >
        <div className="flex flex-col gap-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Button
              ...
              className="w-full"
              onClick={() => {
                window.location.href = process.env.NEXT_PUBLIC_GITHUB_OAUTH_LINK!;
              }}
            >
              <FaGithub />
            ...
            <Button
              ...
              className="w-full"
              onClick={() => {
                window.location.href = process.env.NEXT_PUBLIC_GOOGLE_OAUTH_LINK!;
              }}
            >
              <FaGoogle />
