      ...
      <MaxWidthWrapper className="pb-10 pt-20">
        ...
        <div className="max-w-lg mx-auto my-20 flex flex-col items-center sm:items-start">
          ...
          <div className="text-center font-semibold text-balance ">
            ...
            <span className="bg-yellow-200 dark:text-black">using this app</span> Lorem ipsum
            dolor sit amet consectetur adipisicing elit. Amet, assumenda Lorem
            ipsum, dolor sit amet consectetur adipisicing elit. Iusto, odit
          </div>
